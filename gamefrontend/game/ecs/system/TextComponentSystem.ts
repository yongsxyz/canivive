...
export class TextComponentSystem {
  ...
  private createTextObject(
    ...
    textObject.element.style.pointerEvents = 'auto';
  ...
  private updateTextElementContent(
    ...
    if (!textElement.dataset.initialized) {
      if (isProximityPrompt) {
        ...
        <div id="interaction-button" style="      
          pointer-events: auto;
          cursor: pointer;  /* Ini yang membuat cursor berubah */
        ...
        ">
          <div style="display: flex; align-items: center; pointer-events: none;">
            <div style="
              ...
              margin-right: 0.5rem;
              pointer-events: none;">
              <span style="font-size: 1.5rem; font-weight: bold; color: #FFFFFF; pointer-events: none;">E</span>
            </div>
            <div style="display: flex; flex-direction: column; pointer-events: none;">
              <p class="text-content" style="font-size: 0.875rem; font-weight: 800; line-height: 1.25rem; color: #FFFFFF; pointer-events: none;"></p>
              <p style="font-size: 0.75rem; color: #FFFFFF; text-align: right; margin-left: auto; font-style: italic; pointer-events: none;">Interact</p>
            </div>
          </div>
        </div>
        `
